...
#define BOARD_NAME                    "Mobile Display"           // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "NodeMCU"              // Name of your company. Should match App Export request info.

#define PRODUCT_WIFI_SSID             "Mobile_Display"      // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "mobile-display.cc"        // Config page will be available in a browser at 'http://my-plant.cc/'
...
//#define BOARD_LED_PIN_B             D6
  #define BOARD_LED_PIN_WS2812        D1
